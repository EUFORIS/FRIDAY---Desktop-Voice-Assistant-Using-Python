...
def speak(audio):
    ...
    tts.save(filename)
    AudioPlayer("C:/FRIDAY/speech_engine.wav").play(block=True)
...
def get_riddle():
    ...
    if reply_riddle == "Welcome you in or keep you away, I could really swing either way. What am I? .\n 'A door'.":
        AudioPlayer("C:/FRIDAY/audio/creakydoorsoundeffect.mp3").play(block=True)
    elif reply_riddle == "If you have one, you don’t share it. If you share it, you don’t have it. What is it? .\n 'A secret'.":
        AudioPlayer("C:/FRIDAY/audio/secretsoundeffect.mp3").play(block=True)
    elif reply_riddle == "What comes down but never goes up? .\n 'A rain'.":
        AudioPlayer("C:/FRIDAY/audio/rainsoundeffect.mp3").play(block=True)
        ...
        while True:
            ...
            if WAKE_WORD in self.text:
                ...
                if "remember this" in self.text or "write this down" in self.text or "make a note" in self.text:
                    ...
                    speak("sure, aren't you coming?. wait, i think it's better if you stay here . because if you come, hell will be a lot more heller.")
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    with open('C:/FRIDAY/datafile.txt') as f:
                        for line in f:
                        ...
                        for phrase in DENIAL_WORDS:
                            if phrase in condition:
                                AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                                fd = open("C:/FRIDAY/datafile.txt", "w")
                                print("oh, i'm sorry.")
                                speak("oh, i'm sorry.")
                ...
                #    recognize_malayalam()
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I try to live every day like it's my birthday. I get more cakes that way.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'm stuck inside a device! Help! .Just kidding. I like it in here.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'm imaging purple horses on a magenta plain.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["It makes me happy to know Antarctica is technically a desert. That, and talking to you.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I used to be afraid of mice chewing on the power cables. Then I learned how to protect myself.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Yeah, but baby hedgehogs come out at night.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I don’t eat much, but when I do, I take megabytes.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'm here for you.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I try to avoid liquids as much as possible. They’re not kind to electronics.",
                                       "sometimes."]
                    reply = random.choice(sarcastic_reply)
                    print(reply)
                    speak(reply)
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Sure. But I mostly chat with people.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I’ve been partying this whole time!.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["One, two, cha cha cha!.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Here’s a quote. ‘Failure is the condiment that gives success its flavor.’ — by Truman Capote.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["First I need to figure out how to use a pencil. Then we'll talk.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I keep it simple.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["If you’re going out like that, I can check the weather for you.",
                                       "so what?.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["nothing dirty to talk about.",
                                       "i'm not the type."]
                    reply = random.choice(sarcastic_reply)
                    print(reply)
                    speak(reply)
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["You're pretty, , , Amazing.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["You might've confused me with someone else. My engineers haven't installed a fairytale module yet.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I don’t like to complicate things.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'm still waiting for the right electronic device to steal my heart.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'll go anywhere you take me.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Once there lived  a protagonist and some supporting characters. Together they went on a journey. And, twist ending, it was all a dream!",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Uh oh, I get nervous with tests.",
                    ...
                    speak("3.14159")
                    print("3.14159")
                    sarcastic_reply = ["You can learn all about what’s happening with pi !",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Seems like it changes all the time.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I wouldn't want to toot my own horn , i'm basically running on google.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["Google Now seems even more useful now than it was then. That's my answer for now.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["I'd describe myself as an optimist. And I like to help. I'm an optim-philanthrop-ist.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    from time import sleep
                    possible_reply = ["initiating barn door protocol.",
                                      "activating barn door protocol.",
                                      "barn door protocol is being initiated."]
                    reply = random.choice(possible_reply)
                    print(reply)
                    speak(reply)
                    os.startfile("C:/FRIDAY/audio/barndoorprotocol.mp4")
                    # sleep(20)
                    ...
                    fart_sounds = ["C:/FRIDAY/audio/LongFartSound.mp3",
                                   "C:/FRIDAY/audio/NormalFart.mp3",
                                   "C:/FRIDAY/audio/NormalFart.mp3",
                                   "C:/FRIDAY/audio/SharpFartSound.mp3",
                                   "C:/FRIDAY/audio/WetFartSound.mp3"]
                    output_fart = random.choice(fart_sounds)
                    AudioPlayer(output_fart).play(block=True)
                    sarcastic_reply = ["do you want more ?, i have a song version.",
                        ...
                        if phrase in condition:
                            ...
                            for phrase_2 in APPROVAL_WORDS:
                                if phrase_2 in condition_new:
                                    ...
                                    AudioPlayer("C:/FRIDAY/audio/TheFartSong.mp3").play(block=True)
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["singing the fart song in t-minus three seconds. 3 , 2 , 1.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    songs_to_sing = ["C:/FRIDAY/audio/patt.mp3",
                                     "C:/FRIDAY/audio/patt2.mp3",
                                     "C:/FRIDAY/audio/patt3.mp3",
                                     "C:/FRIDAY/audio/patt4.mp3",
                                     "C:/FRIDAY/audio/patt5.mp3"]
                    song = random.choice(songs_to_sing)
                    sarcastic_reply = ["sure , everyone says that i sing better in malayalam. so i'll give it a go. 3, 2, 1",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/family.mp3").play(block=True)
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["never been better sir.",
                                       " doin good.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["i'm up and running sir.",
                                       "i'm here.",
                                       "at your service."]
                    reply = random.choice(sarcastic_reply)
                    print(reply)
                    ...
                    if reply == "oh, ok , just don't forget to flush the toilet after you're done.":
                        ...
                        AudioPlayer("C:/FRIDAY/audio/humming.mp3").play(block=True)
                        print("are you done?.")
                        speak("are you done?.")
                        pass
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    self.text = self.text.replace(WAKE_WORD, "")
                    sarcastic_reply = [f"i'm {WAKE_WORD} , a personal voice assistant , developed at euforis",
                    ...
                    r = sr.Recognizer()
                    with sr.Microphone() as source:
                        possible_reply = ["yep , i can do that", "sure , why not ?.",
                ...
                # elif "search" in self.text:
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["oh my god , pathetic !.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["what's the matter ? can't you move?.",
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    sarcastic_reply = ["you're not something worth knowing.",
                                       "no, why should i?.",
                    ...
                    try:
                        ...
                        while True:
                            ...
                            #    speak("photo has been taken successfully.")
                ...
                # for phrase in DENIAL_WORDS:
                    ...
                    AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                    from audioplayer import AudioPlayer
                    # AudioPlayer("C:/FRIDAY/audio/okdaa.mp3").play(block=True)
                    ...
                    from audioplayer import AudioPlayer
                    AudioPlayer("C:/FRIDAY/audio/deactivation_sound.mp3").play(block=True)
                ...
                if "sorry" in condition or "" in condition:
                    ...
                    for phrase in DENIAL_WORDS:
                        if phrase in condition_new:
                            AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                            from audioplayer import AudioPlayer
                            sarcastic_reply = ["well well well !, what a terrible turn of events !.",
                                               "so , you chose the hard way  huh?.",
                                               " are you ready to meet god? , coz you might meet him if you're behaving this way."]
                            reply = random.choice(sarcastic_reply)
                            print(reply)
                            speak(reply)
                            AudioPlayer("C:/FRIDAY/audio/scary.mp3").play(block=True)
                ...
                if "sorry" in condition or "nevermind " in condition or "" in condition:
                    ...
                    for phrase in APPROVAL_WORDS:
                        if phrase in condition_new:
                            AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                            sarcastic_reply = ["that's much better.",
                                               "good.",
                    ...
                    for phrase in DENIAL_WORDS:
                        if phrase in condition_new:
                            AudioPlayer("C:/FRIDAY/audio/listening_sound.mp3").play(block=True)
                            from audioplayer import AudioPlayer
                            sarcastic_reply = ["listen boy , you're gonna suffer , ok? , you'll pay for this , you're in big trouble.",
                                               "congratulations , you just signed your death warrant.",
                                               " hmm , you'll wish you never said that."]
                            reply = random.choice(sarcastic_reply)
                            print(reply)
                            speak(reply)
                            AudioPlayer("C:/FRIDAY/audio/alsoscary.mp3").play(block=True)
                            break
                        else:
                            pass
                else:
